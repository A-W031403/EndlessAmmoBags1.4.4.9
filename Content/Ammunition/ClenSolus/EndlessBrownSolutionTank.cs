...
{
    public class EndlessBrownSolutionTank : ModItem
    {
        ...
        {
            CreateRecipe()
                .AddIngredient(ItemID.DirtSolution, 7500) // AddIngredient takes ItemID, then Quantity
